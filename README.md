...
> [!TIP]
> Das Setup erstellt eine Verknüpfung im Windows-Autostart, die `ShareMouse_AutoReload.exe` startet. Diese Datei wurde mit dem ShareMouse-Icon ![ShareMouse Auto-Reload Banner](assets/autostart_icon.png)kompiliert, sodass sie korrekt im Task-Manager angezeigt wird.
